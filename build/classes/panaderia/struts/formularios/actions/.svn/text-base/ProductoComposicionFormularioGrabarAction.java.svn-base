...
public class ProductoComposicionFormularioGrabarAction extends Action {
	...
	{              		
		...
		try{
			...
			ProductoComposicion composicion = new ProductoComposicion();
			composicion.cargaDatosFormularioStruts( request );
			composicion.setProdcompProdfId(prodfId);
