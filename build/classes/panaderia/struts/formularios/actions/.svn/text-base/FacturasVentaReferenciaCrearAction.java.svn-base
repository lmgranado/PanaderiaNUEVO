...
public class FacturasVentaReferenciaCrearAction extends Action {
	...
	{              		
		...
		int resultado = -2;
		try{
			String fvId = request.getParameter("fvRef");
			FacturasVenta facturaventa = new FacturasVenta();
			
			resultado = facturaventa.crearFacturaRectificativa(fvId);
