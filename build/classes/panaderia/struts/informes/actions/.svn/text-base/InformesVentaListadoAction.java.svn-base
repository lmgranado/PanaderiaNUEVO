...
public class InformesVentaListadoAction extends Action {
	...
	{              
		...
		try{
			request.setAttribute("PRODUCTOSLISTA", Productos.getAllProductos());
		...
		int intOrden = 0;
		Boton boton = new Boton("IMPRIMIR","Generar Gráficas","img/imprimir.png","boton", "javascript:doInformesVenta();");
