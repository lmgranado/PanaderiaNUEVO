...
var menuItems = [
             ...
             ["Ficheros Maestros","", "img/play_azul.gif", "", "", "", "", "", "", ],
             ...
             ["Ventas","", "img/play_azul.gif", "", "", "", "", "", "", ],
             	["|Nueva Factura","doFacturasVentaFormulario.do?fvTipo=1", "img/play_naranja.gif", "", "", "", "", "", "", ],
                 ["|Listado Facturas","doListadoFacturasVenta.do", "img/play_naranja.gif", "", "", "", "", "", "", ],
                 ["|Factura Abono","doFacturasVentaFormulario.do?fvTipo=2", "img/play_naranja.gif", "", "", "", "", "", "", ],
             ["Compras","", "img/play_azul.gif", "", "", "", "", "", "", ],
                 ["|Nueva Factura","doFacturasCompraFormulario.do", "img/play_naranja.gif", "", "", "", "", "", "", ],
                 ["|Listado Facturas","doListadoFacturasCompra.do", "img/play_naranja.gif", "", "", "", "", "", "", ],
