...
<script type="text/javascript">
	...
	function doSubmit(){
		...
		if( document.getElementById('hinvFecha').value=='' ){
			alert('Debe elegir una Fecha válida');
			return;
		}else{
...
<table style="background-color: white; border: 1px solid #E5E5E5; width: 100%">
		...
		<img src="img/factura.png"/> Histórico de Inventarios y Regularizaciones</span>
		<br><br>
	<tr>          
		  <td colspan="4" align="right">
		  	<span style='color: #FA7D3D; font-size: 12px; font-weight: bold;'>
				<c:if test="${!empty historicoinventarios.hinvId}">
					Número Inventario: ${historicoinventarios.hinvId}
				</c:if>	
			</span>
		  </td>
	    </tr>
	<tr>
		<td colspan="7" style="font-family: Verdana; font-size: 11px; color: #2DACE4;padding: 5px 0px 0px 5px">
			<img src="img/play.gif"/>&nbsp;Datos Básicos del Inventario/Regularización<br>
...
<c:if test="${!empty historicoinventarios.hinvId}">
	<tr>
		<td colspan="7" style="font-family: Verdana; font-size: 11px; color: #2DACE4;padding: 5px 0px 0px 5px">
			<img src="img/play.gif"/>&nbsp;Detalles del Inventario/Regularización<br>
			<hr style="color: #DFDEDE">
