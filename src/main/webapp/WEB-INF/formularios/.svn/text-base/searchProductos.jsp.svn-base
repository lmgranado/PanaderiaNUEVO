...
<script type="text/javascript">
	...
	function doSubmit(){
		...
		if( validaCampos( idProducto, cantidad) ){
			document.getElementById('frmDetalle').action = 'doFacturasVentaDetalleGrabar.do?prodId=' + idProducto + '&cantidad='+ cantidad+'&fvClId=${fvClId}';
...
<html:form action="/doVentanaSearchProductosFactura" styleId="frmDetalle"  method="post">	
	...
	<tr>
		<td colspan="7">
				...
				<display:table name="LISTAPRODUCTOS" id="productos" export="false"
					...
					sort="external" class="" requestURI="/doVentanaSearchProductosFactura.do"
