...
<script type="text/javascript">
	...
	function doSubmit(){
		...
		var tipoFactura = document.getElementById('fvTipo').value;				
		...
		if( IdUsuario == -1 ){
			...
			window.opener.document.getElementById('frmDetalle').action = 'doFacturasVentaFormulario.do?fvClId='+IdUsuario+'&fvTipo='+tipoFactura;
...
<html:form action="/doVentanaSearchClienteFactura" styleId="frmDetalle"  method="post">	
	...
	<tr>
		<td colspan="7">
				...
				<display:table name="LISTACLIENTES" id="clientes" export="false"
					...
					sort="external" class="" requestURI="/doVentanaSearchClienteFactura.do"
