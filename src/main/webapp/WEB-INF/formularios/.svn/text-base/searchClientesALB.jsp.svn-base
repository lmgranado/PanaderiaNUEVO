...
<script type="text/javascript">
	...
	function doSubmit(){
		...
		if( IdUsuario == -1 ){
			...
			window.opener.document.getElementById('frmDetalle').action = 'doAlbaranesVentaFormulario.do?avClId=' + IdUsuario;
...
<html:form action="/doVentanaSearchClienteAlbaran" styleId="frmDetalle"  method="post">	
	...
	<tr>
		<td colspan="7">
				...
				<display:table name="LISTACLIENTES" id="clientes" export="false"
					...
					sort="external" class="" requestURI="/doVentanaSearchClienteAlbaran.do"
	...
	<input type='hidden' value="${avId}" name="avId" />
