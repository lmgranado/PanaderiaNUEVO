...
<table style="background-color: white; border: 1px solid #E5E5E5; width: 100%">
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0" class="texto">
              <tr> 
                ...
                <td style='width: 30%' align="left"> 
                	<c:if test="${!empty Producto.prodId}">
						<html:text styleClass="js_requerido" size='28' readonly="true" maxlength="30" property="prodNombre" name="prodNombre" value="${Producto.prodNombre}"/>&nbsp;
					</c:if>
					<c:if test="${empty Producto.prodId}">
              ...
              <tr> 
                ...
                <td style='width: 40%' align="left"> 
					...
					<html:select  styleClass="js_requerido"  style="width: 160px" styleId="prodIva" property="prodIva" value="${prodIva}">
						  ...
						  <html:option value="0,10">10%</html:option>
        ...
        <tr> 
          <td align="center" colspan='4' style="padding-left: 20px;"> 
			<table width="100%" border="0" cellpadding="0" cellspacing="0" class="texto">
              <tr> 
                <td style='width: 15%' align="left" class="texto_negrita">¿Es producto de Venta?</td>
                <td style='width: 40%' align="left"> 
