  ...
  public static Object[] getAlbaranesVentaLista(PaginatedListTest listaPaginada) 
  {
  	...
  	try{
    	...
    	if(!Utils.empty(albaranesventaFiltro.getAvClId()))
    		sqlAñadido += "AND " + AVCLID + " = '" + albaranesventaFiltro.getAvClId() + "'";
    	if( albaranesventaFiltro.getAvFecha() != null )
    		sqlAñadido += "AND " + AVFECHA + " = '" + albaranesventaFiltro.getAvFecha() + "'";
    	if(!Utils.empty(albaranesventaFiltro.getAvId()))
    		sqlAñadido += "AND " + AVID + " like '%" + albaranesventaFiltro.getAvId() + "%'";
    	if(!Utils.empty(albaranesventaFiltro.getAvIva()))
    		sqlAñadido += "AND " + AVIVA + " = '" + albaranesventaFiltro.getAvIva() + "'";
    	if(!Utils.empty(albaranesventaFiltro.getAvObservaciones()))
    		sqlAñadido += "AND UPPER(" + AVOBSERVACIONES + ") like UPPER('%" + albaranesventaFiltro.getAvObservaciones() + "%')";
    	if(!Utils.empty(albaranesventaFiltro.getAvPagado()))
    		sqlAñadido += "AND " + AVPAGADO + " = '" + albaranesventaFiltro.getAvPagado() + "'";
    	if(!Utils.empty(albaranesventaFiltro.getAvTotal()))
    		sqlAñadido += "AND " + AVTOTAL + " = '" + albaranesventaFiltro.getAvTotal() + "'";
    	if( !Utils.empty( albaranesventaFiltro.getClPfId() ) )
    		sqlAñadido += "AND " + CLPFID + " = '" + ( albaranesventaFiltro.getClPfId())+ "'";
    	if( !Utils.empty( albaranesventaFiltro.getAvCierre() ) )
    		sqlAñadido += "AND " + AVCIERRE + " = '" + ( albaranesventaFiltro.getAvCierre())+ "'";
    	if( !Utils.empty( albaranesventaFiltro.getAvNumero() ) )
    		sqlAñadido += "AND " + AVNUMERO + " = '" + ( albaranesventaFiltro.getAvNumero())+ "'";
    	if( !Utils.empty( albaranesventaFiltro.getAvTipo() ) )
    		sqlAñadido += "AND " + AVTIPO + " = '" + ( albaranesventaFiltro.getAvTipo())+ "'";
    	...
    	if( albaranesventaFiltro.getAvFechaDesde()!=null && albaranesventaFiltro.getAvFechaHasta()!=null )
    		sqlAñadido += "AND " +AVFECHA+" BETWEEN '"+albaranesventaFiltro.getAvFechaDesde()+"' AND '"+albaranesventaFiltro.getAvFechaHasta()+"' ";
    	else if( albaranesventaFiltro.getAvFechaDesde()!=null ) 
    		sqlAñadido += "AND " + AVFECHA + " >= '" + albaranesventaFiltro.getAvFechaDesde() + "'";
    	else if( albaranesventaFiltro.getAvFechaHasta()!=null )
    		sqlAñadido += "AND " + AVFECHA + " <= '" + albaranesventaFiltro.getAvFechaHasta() + "'";
  	}catch(Exception e){
  		System.out.println(e);
  	}
    return UtilesDAO.generaSqlListadoPaginado(sql + sqlAñadido, listaPaginada, albaranesventa);
  }
}
