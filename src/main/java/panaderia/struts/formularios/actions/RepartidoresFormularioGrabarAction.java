...
public class RepartidoresFormularioGrabarAction extends Action {
	...
	{              		
		...
		try{
			...
			repartidor.cargaDatosFormularioStruts(request);
			if( Utils.skipNull(repId).equals("") )
				resultado = repartidor.inserta();
			else
				resultado = repartidor.actualiza();
