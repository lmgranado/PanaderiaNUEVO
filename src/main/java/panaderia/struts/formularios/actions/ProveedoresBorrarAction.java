...
public class ProveedoresBorrarAction extends Action {
	...
	{              		
		...
		for(int i=0; i<chkValues.length; i++){
			...
			if(chkValues[i].equals("999") || chkValues[i].equals("998")){
				throw new Exception("No se pueden eliminar los proveedores de fabricación");
			}
			proveedor.setPrId(chkValues[i]);
			resultado = proveedor.elimina();
		}
