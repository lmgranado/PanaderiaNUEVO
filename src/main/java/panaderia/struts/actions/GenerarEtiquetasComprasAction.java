...
import panaderia.negocio.bCuerposEtiquetasComprasPdf;
...
public class GenerarEtiquetasComprasAction extends Action{
	...
	public ActionForward execute(ActionMapping mapping, 
		...
		try{
		    ...
		    while(enumera.hasMoreElements()){
		    	...
		    	if( nombrePS.indexOf("fcdId_") != -1 ){
		    		
		    		String fcdId = nombrePS.replace("fcdId_", "");
					FacturasCompraDetalle detalle = FacturasCompraDetalle.getFacturasCompraDetalleByFcdId( fcdId );
					Stock stock = Stock.getStockByStId( detalle.getFcdStId() );
