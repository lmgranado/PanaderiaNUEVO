...
public class FacturasCompraListadoAction extends Action {
	...
	{              
		...
		try{
	        ...
	        Object[] consulta = FacturasCompra.getFacturasCompraLista(lista);
    		...
    		ArrayList proveedores = Proveedores.getAllProveedoresCompra();
		...
		//Luis Miguel -> 18/07/14
		//Boton boton = new Boton("ESTADO","Actualizar Estado","img/actualizaEstado.png","boton", "javascript:doActualizaFactura();");
