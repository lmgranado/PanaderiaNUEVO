...
public class MultipartRequest
{
    ...
    */
    ...
    public String getHtmlTable(String sTrans)
    {
        ...
        {
            sbReturn.append("<p align=\"center\"><font color=red> Excedido el máximo permitido: ("+this.intContentLength+" > "+this.intMaxContentLength+") todos los archivos subidos ignorados.</font></p>\n");
        }
        else 
        {
