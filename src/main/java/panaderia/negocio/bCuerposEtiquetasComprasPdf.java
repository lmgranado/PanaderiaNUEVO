...
public class bCuerposEtiquetasComprasPdf extends PdfPageEventHelper{
    ...
    public void generaEtiquetas( Document document, FacturasCompraDetalle detalle, int numEtiquetas, Image imagen ) throws DocumentException, IOException{
		...
		try{
			...
			for(int j=0; j<numEtiquetas; j++){
			 	...
			 	PdfPCell celdaTexto = new PdfPCell(new Phrase(detalle.getFcdProducto(), fuenteNombre));
