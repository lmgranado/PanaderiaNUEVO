...
public class bCuerposGraficaVentasPdf extends PdfPageEventHelper{
	...
	public PdfPTable generaCabeceraInforme( HttpServletRequest request ){
		...
		try{
	      ...
	      PdfPCell celdaDatos = new PdfPCell(new Phrase("Filtro para la generación de las gráficas", fuenteParrafo));
	      ...
	      PdfPCell celdaNombreListado = new PdfPCell(new Phrase("Gráficas de Productos", fuenteNotaGrande));
